...
router.post('/activityCenter/pubg/refreshSpringPubgTicket', async (ctx) => {
  ctx.body = {
    "code": 0,
    "data":99
  }
})
router.post("/activityCenter/lottery", (ctx) => {
  ctx.body = {
    code: "0",
    msg: "很遗憾！您未中奖，再接再厉吧！",
    success: true,
    data:{
      winAwardNo: "WEEK_CARD_3",
      awardRecordId: 1030,
      awardName: "3元周卡抵扣券",
      exchangeCode: "123",
    },
...
router.get("/activityCenter/info", (ctx) => {
  ctx.body = {
    code: "0",
    msg: "success",
    success: true,
    data: {
      startTime: "2023-1-09 00:00:00",
      endTime: "2022-12-26 23:59:59",
      activityStatus: 1,
      turnTableInfo: { awardList: [] },
      activityEntranceUrl:'https://ppjumper.dxinzf.com/ppstatic/img/baidu/pubg-banner.png'
    },
  };
});
router.post("/activityCenter/award/refreshRechargeTicket", (ctx) => {
  ctx.body = {
    code: "0",
    msg: "绑定成功",
    success: true,
...
router.post("/activityCenter/award/refreshRegisterTicket", (ctx) => {
  ctx.body = {
    code: "3",
    msg: "绑定成功",
    success: true,
...
router.post("/activityCenter/award/refreshTotalRechargeTicket", (ctx) => {
  ctx.body = {
    code: "0",
    msg: "绑定成功",
    success: true,
  ...
  ctx.body = {
    ...
    "data": {
      ...
      "list": [{
        ...
        "awardCategoryNo": "MOON_BOX",
        "awardName": "月圆宝箱",
        "exchangeCodes": "ACC_VIP-NOYP-F23B-2Z0YD"
      }, {
        "awardTime": "2022-12-09 11:15:59",
        "activityName": "击杀成就",
...
router.get('/activityCenter/pubg/getActivityTaskInfo', ctx => {
      ...
      "data": {
        ...
        "awards": [{
          ...
          },
          {
            ...
            "awardCategories": [{
              "awardName": "12月3号",
              "awardUrl": "https://img12.360buyimg.com/n1/s450x450_jfs/t1/146052/2/33823/43802/63c0c71aFd912f402/1d1eb44cb3ac9f40.jpg",
  ...
  if (ctx_query.taskNo == 'GATHER_EXCHANGE') {
    json = {
      "code": "0",
      "msg": "success",
      "success": true,
      "data": {
        "taskNo": "GATHER_EXCHANGE",
        "taskRemark": 25,
        "awards": [{
    ...
    json = {
      ...
      "data": {
        ...
        "awards": [{
          ...
          {
            "awardKey": "GAME_ONLINE_20221205",
            "remark": "买月卡送套装：群星之力头盔;群星之力背包;群星之力长裤;大吉大利黑T;鸡斯卡喷漆C;鸡斯卡喷漆S;鸡斯卡喷漆P",
            "taskStatus": 4,
            "awardCategories": [{
              "awardName": "12月5号",
              "awardUrl": "",
...
router.get('/activityCenter/pubg/abc.json', ctx => {
  ctx.body = {
    "bannerUrl":"https://ppjumper.dxinzf.com/ppstatic/img/baidu/pubg-banner.png",
    "pubgLink":{
        "url":"https://www.baidu.com",
        "name":"PUBG外链"
    }
